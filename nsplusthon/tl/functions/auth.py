...
class DeleteAccountRequest(TLRequest):
    ...
    def __init__(self, delete_account_code: str):
        """
        :returns Bool: This type has no constructors.
        """
        self.delete_account_code = delete_account_code

    def to_dict(self):
        return {
            '_': 'DeleteAccountRequest',
            'delete_account_code': self.delete_account_code
        }

    def _bytes(self):
        return b''.join((
            b'\xc2\x1e\x1aD',
            self.serialize_bytes(self.delete_account_code),
        ))

    @classmethod
    def from_reader(cls, reader):
        _delete_account_code = reader.tgread_string()
        return cls(delete_account_code=_delete_account_code)
...
class ResendDeleteAccountCodeRequest(TLRequest):
    CONSTRUCTOR_ID = 0x633a65a0
    SUBCLASS_OF_ID = 0x719f5ef3

    def to_dict(self):
        return {
            '_': 'ResendDeleteAccountCodeRequest'
        }
...
class SendDeleteAccountCodeRequest(TLRequest):
    CONSTRUCTOR_ID = 0x7fb3ddc0
    SUBCLASS_OF_ID = 0x719f5ef3

    def to_dict(self):
        return {
            '_': 'SendDeleteAccountCodeRequest'
        }
