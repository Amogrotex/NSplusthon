...
class Button:
    ...
    .. note::
        ...
        `Message.buttons <nsplusthon.tl.custom.message.Message.buttons>`
    ...
    def inline(text, data=None):
        ...
        <nsplusthon.events.callbackquery.CallbackQuery>` will trigger with the
        ...
        Args:
            bot (`hints.EntityLike`):
                ...
                .. note::
                    ...
                    <nsplusthon.client.users.UserMethods.get_input_entity>`.
    ...
    def text(cls, text, *, resize=None, single_use=None, selective=None,
        ...
        <nsplusthon.events.newmessage.NewMessage>`. You cannot distinguish
