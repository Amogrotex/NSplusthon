...
class Message(ChatGetter, SenderGetter, TLObject):
    ...
    <nsplusthon.tl.custom.chatgetter.ChatGetter>` and `SenderGetter
    <nsplusthon.tl.custom.sendergetter.SenderGetter>` which means you
    ...
    Members:
        ...
        message (`str`):
            ...
            <nsplusthon.tl.custom.message.Message>` instances,
    ...
    def client(self):
        """
        Returns the `SoroushClient <nsplusthon.client.soroushclient.SoroushClient>`
    ...
    def forward(self):
        """
        The `Forward <nsplusthon.tl.custom.forward.Forward>`
    ...
    def buttons(self):
        ...
        <nsplusthon.tl.custom.messagebutton.MessageButton>`,
        if any.
    ...
    def file(self):
        """
        Returns a `File <nsplusthon.tl.custom.file.File>` wrapping the
        ...
        `file.id <nsplusthon.tl.custom.file.File.id>`,
        `file.name <nsplusthon.tl.custom.file.File.name>`,
    ...
    def get_entities_text(self, cls=None):
        ...
        Args:
            cls (`type`):
                ...
                >>> from nsplusthon.tl.types import MessageEntityCode
                >>>
                >>> m = ...  # get the message
    ...
    async def respond(self, *args, **kwargs):
        ...
        `nsplusthon.client.messages.MessageMethods.send_message`
    ...
    async def forward_to(self, *args, **kwargs):
        ...
        `nsplusthon.client.messages.MessageMethods.forward_messages`
        ...
        `nsplusthon.client.soroushclient.SoroushClient` instance directly.
        """
        if self._client:
    ...
    async def edit(self, *args, **kwargs):
        ...
        `nsplusthon.client.messages.MessageMethods.edit_message`
    ...
    async def delete(self, *args, **kwargs):
        ...
        Shorthand for
        `nsplusthon.client.messages.MessageMethods.delete_messages` with
    ...
    async def download_media(self, *args, **kwargs):
        ...
        for `nsplusthon.client.downloads.DownloadMethods.download_media`
    ...
    async def click(self, i=None, j=None,
        ...
        or `button.click <nsplusthon.tl.custom.messagebutton.MessageButton.click>`
        ...
        Args:
            ...
            filter (`callable`):
                ...
                `MessageButton <nsplusthon.tl.custom.messagebutton.MessageButton>`
                or `PollAnswer <nsplusthon.tl.types.PollAnswer>` argument.
    ...
    async def mark_read(self):
        ...
        <nsplusthon.client.messages.MessageMethods.send_read_acknowledge>`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
    ...
    async def pin(self, *, notify=False, pm_oneside=False):
        ...
        `nsplusthon.client.messages.MessageMethods.pin_message`
        with both ``entity`` and ``message`` already set.
        """
    ...
    async def unpin(self):
        ...
        `nsplusthon.client.messages.MessageMethods.unpin_message`
        with both ``entity`` and ``message`` already set.
        """
        if self._client:
