...
class Conversation(ChatGetter):
    ...
    async def send_message(self, *args, **kwargs):
        ...
        for `nsplusthon.client.messages.MessageMethods.send_message` with
        ``entity`` already set.
        """
    ...
    async def send_file(self, *args, **kwargs):
        ...
        for `nsplusthon.client.uploads.UploadMethods.send_file` with
        ``entity`` already set.
        """
    ...
    def get_response(self, message=None, *, timeout=None):
        ...
        Args:
            message (`Message <nsplusthon.tl.custom.message.Message>` | `int`, optional):
