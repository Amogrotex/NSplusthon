...
class InlineBuilder:
    ...
    <nsplusthon.events.inlinequery.InlineQuery>` ``results``.
    ...
    explained here to avoid repetition:
        ...
        buttons (`list`, `custom.Button <nsplusthon.tl.custom.button.Button>`, :tl:`KeyboardButton`, optional):
    ...
    async def photo(
        ...
        Args:
            ...
            file (`obj`, optional):
                ...
                <nsplusthon.client.uploads.UploadMethods.send_file>`.
