...
class MessageEdited(NewMessage):
    ...
    <nsplusthon.events.newmessage.NewMessage>`, you should treat
    this event as a `Message <nsplusthon.tl.custom.message.Message>`.

    .. warning::

        On channels, `Message.out <nsplusthon.tl.custom.message.Message>`
