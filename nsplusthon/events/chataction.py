...
class ChatAction(EventBuilder):
    ...
    * Whenever a user is removed or leaves a group if it has
    ...
    class Event(EventCommon):
        ...
        Members:
            action_message  (`MessageAction <https://tl.nsplusthon.dev/types/message_action.html>`_):
        ...
        async def get_pinned_message(self):
            ...
            <nsplusthon.tl.custom.message.Message>` object that was pinned.
            """
        ...
        async def get_pinned_messages(self):
            ...
            <nsplusthon.tl.custom.message.Message>` objects that were pinned.
            """
