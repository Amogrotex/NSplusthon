...
class CallbackQuery(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        async def respond(self, *args, **kwargs):
            ...
            `nsplusthon.client.messages.MessageMethods.send_message` with
            ``entity`` already set.
        ...
        async def edit(self, *args, **kwargs):
            ...
            `nsplusthon.client.messages.MessageMethods.edit_message` with
            ...
            .. note::
                ...
                `Message.edit <nsplusthon.tl.custom.message.Message.edit>`,
