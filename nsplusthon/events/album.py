...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        Members:
            messages (Sequence[`Message <nsplusthon.tl.custom.message.Message>`]):
        ...
        async def get_reply_message(self):
            """
            The `Message <nsplusthon.tl.custom.message.Message>`
        ...
        async def reply(self, *args, **kwargs):
            ...
            for `nsplusthon.client.messages.MessageMethods.send_message`
