...
class UserMethods:
    ...
    async def get_me(self: 'SoroushClient', input_peer: bool = False) \
    ...
    @property
    def _self_id(self: 'SoroushClient') -> typing.Optional[int]:
        """
    ...
    async def is_bot(self: 'SoroushClient') -> bool:
        """
    ...
    async def is_user_authorized(self: 'SoroushClient') -> bool:
        """
    ...
    async def get_input_entity(
        ...
        raise ValueError(
            ...
            'docs.nsplusthon.dev/en/stable/concepts/entities.html to'
    ...
    async def _get_entity_from_string(self: 'SoroushClient', string):
        """
    ...
    async def _get_input_dialog(self: 'SoroushClient', dialog):
        """
    ...
    async def _get_input_notify(self: 'SoroushClient', notify):
        """
