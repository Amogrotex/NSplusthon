...
class DownloadMethods:
    ...
    async def download_media(
        ...
        See also `Message.download_media() <nsplusthon.tl.custom.message.Message.download_media>`.

        Arguments
            message (`Message <nsplusthon.tl.custom.message.Message>` | :tl:`Media`):
    ...
    async def download_file(
        ...
        Arguments
            input_location (:tl:`InputFileLocation`):
                ...
                See `nsplusthon.utils.get_input_location` source for a complete
    ...
    def _download_cached_photo_size(self: 'SoroushClient', size, file):
    ...
    async def _download_photo(self: 'SoroushClient', photo, file, date, thumb, progress_callback):
