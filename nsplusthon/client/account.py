...
class AccountMethods:
    def takeout(
            ...
            *,
            ...
            channels: bool = None,
            files: bool = None,
            max_file_size: bool = None) -> 'SoroushClient':
        """
        Returns a :ref:`nsplusthon-client` which calls methods behind a takeout session.
        ...
        <nsplusthon.client.messages.MessageMethods.iter_messages>`.
        ...
        <nsplusthon.sessions.abstract.Session.takeout_id>`.
    ...
    async def end_takeout(self: 'SoroushClient', success: bool) -> bool:
        """
