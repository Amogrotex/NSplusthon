...
class BotMethods:
    async def inline_query(
        ...
        Returns
            ...
            <nsplusthon.tl.custom.inlineresult.InlineResult>`.

        Example
            .. code-block:: python

                # Make an inline query to @like
                results = await client.inline_query('like', 'Do you like NSplusthon?')

                # Send the first result to some chat
                message = await results[0].click('NSplusthonOffTopic')
        """
