        ...
        for d in r.dialogs:
            ...
            if peer_id not in self.seen:
                ...
                if peer_id not in entities:
                    ...
                    # Real world example: https://splus.ir/NSplusthonChat/271471
                    continue
...
class DialogMethods:
    ...
    def iter_dialogs(
        ...
        Yields
            Instances of `Dialog <nsplusthon.tl.custom.dialog.Dialog>`.
    ...
    async def get_dialogs(self: 'SoroushClient', *args, **kwargs) -> 'hints.TotalList':
        """
    ...
    def iter_drafts(
        ...
        Yields
            Instances of `Draft <nsplusthon.tl.custom.draft.Draft>`.
    ...
    async def delete_dialog(
        ...
        See also `Dialog.delete() <nsplusthon.tl.custom.dialog.Dialog.delete>`.
    ...
    def conversation(
        ...
        """
        Creates a `Conversation <nsplusthon.tl.custom.conversation.Conversation>`
        ...
        Arguments
            ...
            replies_are_responses (`bool`, optional):
                ...
                <nsplusthon.tl.custom.conversation.Conversation.get_response>`
                and a subsequent call to `conv.get_reply
                <nsplusthon.tl.custom.conversation.Conversation.get_reply>`
        ...
        Returns
            A `Conversation <nsplusthon.tl.custom.conversation.Conversation>`.
