    ...
    async def qr_login(self: 'SoroushClient', ignored_ids: typing.List[int] = None) -> custom.QRLogin:
        ...
        Example
            .. code-block:: python
                ...
                # If you have 2FA enabled, `wait` will raise `nsplusthon.errors.SessionPasswordNeededError`.
    ...
    async def edit_2fa(
        ...
        Example
            .. code-block:: python
                ...
                await client.edit_2fa(new_password='I_<3_NSplusthon')

                # Removing the password
                await client.edit_2fa(current_password='I_<3_NSplusthon')
        """
