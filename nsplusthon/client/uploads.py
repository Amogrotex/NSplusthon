...
class UploadMethods:
    ...
    async def send_file(
        ...
        Arguments
            ...
            file (`str` | `bytes` | `file` | `media`):
                ...
                * A Bot API-like ``file_id``. You can convert previously
                  ...
                  `nsplusthon.utils.pack_bot_file_id`.
            ...
            reply_to (`int` | `Message <nsplusthon.tl.custom.message.Message>`):
        ...
        Returns
            The `Message <nsplusthon.tl.custom.message.Message>` (or messages)
        ...
        Example
            .. code-block:: python
                ...
                from nsplusthon.tl import types
    ...
    async def _send_album(self: 'SoroushClient', entity, files, caption='',
    ...
    async def upload_file(
        ...
        Returns
            ...
            `InputSizedFile <nsplusthon.tl.custom.inputsizedfile.InputSizedFile>`
