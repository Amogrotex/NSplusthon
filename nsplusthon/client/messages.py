...
class MessageMethods:
    ...
    def iter_messages(
        ...
        Arguments
            ...
            reply_to (`int`, optional):
                ...
                will result in ``nsplusthon.errors.PeerIdInvalidError`` to occur.
        ...
        Yields
            Instances of `Message <nsplusthon.tl.custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from nsplusthon.tl.types import InputMessagesFilterPhotos
    ...
    async def get_messages(
        ...
        a single `Message <nsplusthon.tl.custom.message.Message>` will be
    ...
    async def send_message(
        ...
        See also `Message.respond() <nsplusthon.tl.custom.message.Message.respond>`
        and `Message.reply() <nsplusthon.tl.custom.message.Message.reply>`.

        Arguments
            entity (`entity`):
                To who will it be sent.

            message (`str` | `Message <nsplusthon.tl.custom.message.Message>`):
            ...
            reply_to (`int` | `Message <nsplusthon.tl.custom.message.Message>`, optional):
            ...
            parse_mode (`object`, optional):
                See the `SoroushClient.parse_mode
                <nsplusthon.client.messageparse.MessageParseMethods.parse_mode>`
            ...
            buttons (`list`, `custom.Button <nsplusthon.tl.custom.button.Button>`, :tl:`KeyboardButton`):
            ...
            comment_to (`int` | `Message <nsplusthon.tl.custom.message.Message>`, optional):
                Similar to ``reply_to``, but replies in the linked group of a
                broadcast channel instead (effectively leaving a "comment to"
                the specified message).

                This parameter takes precedence over ``reply_to``. If there is
                no linked chat, `nsplusthon.errors.sgIdInvalidError` is raised.
        ...
        Returns
            The sent `custom.Message <nsplusthon.tl.custom.message.Message>`.
        ...
        Example
            .. code-block:: python
                ...
                from nsplusthon import events, Button
    ...
    async def forward_messages(
        ...
        See also `Message.forward_to() <nsplusthon.tl.custom.message.Message.forward_to>`.

        Arguments
            entity (`entity`):
                To which entity the message(s) will be forwarded.

            messages (`list` | `int` | `Message <nsplusthon.tl.custom.message.Message>`):
        ...
        Returns
            The list of forwarded `Message <nsplusthon.tl.custom.message.Message>`,
    ...
    async def edit_message(
        ...
        See also `Message.edit() <nsplusthon.tl.custom.message.Message.edit>`.

        Arguments
            entity (`entity` | `Message <nsplusthon.tl.custom.message.Message>`):
            ...
            message (`int` | `Message <nsplusthon.tl.custom.message.Message>` | :tl:`InputMessageID` | `str`):
                The ID of the message (or `Message
                <nsplusthon.tl.custom.message.Message>` itself) to be edited.
                If the `entity` was a `Message
                <nsplusthon.tl.custom.message.Message>`, then this message
                will be treated as the new text.

            text (`str`, optional):
                The new text of the message. Does nothing if the `entity`
                was a `Message <nsplusthon.tl.custom.message.Message>`.
        ...
        Returns
            The edited `Message <nsplusthon.tl.custom.message.Message>`,
    ...
    async def delete_messages(
        ...
        See also `Message.delete() <nsplusthon.tl.custom.message.Message.delete>`.
        ...
        Arguments
            ...
            message_ids (`list` | `int` | `Message <nsplusthon.tl.custom.message.Message>`):
    ...
    async def send_read_acknowledge(
        ...
        See also `Message.mark_read() <nsplusthon.tl.custom.message.Message.mark_read>`.

        Arguments
            entity (`entity`):
                The chat where these messages are located.

            message (`list` | `Message <nsplusthon.tl.custom.message.Message>`):
    ...
    async def pin_message(
        ...
        See also `Message.pin() <nsplusthon.tl.custom.message.Message.pin>`.

        Arguments
            entity (`entity`):
                The chat where the message should be pinned.

            message (`int` | `Message <nsplusthon.tl.custom.message.Message>`):
    ...
    async def unpin_message(
        ...
        See also `Message.unpin() <nsplusthon.tl.custom.message.Message.unpin>`.
