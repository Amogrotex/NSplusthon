...
class MessageParseMethods:
    ...
    @property
    def parse_mode(self: 'SoroushClient'):
        """
        This property is the default parse mode used when sending messages.
        Defaults to `nsplusthon.extensions.markdown`. It will always
    ...
    @parse_mode.setter
    def parse_mode(self: 'SoroushClient', mode: str):
    ...
    async def _replace_with_mention(self: 'SoroushClient', entities, i, user):
        """
    ...
    async def _parse_message_text(self: 'SoroushClient', message, parse_mode):
        """
    ...
    def _get_response_message(self: 'SoroushClient', request, result, input_chat):
        """
