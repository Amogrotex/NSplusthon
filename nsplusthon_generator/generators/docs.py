...
def get_import_code(tlobject):
    ...
    return 'from nsplusthon.tl.{}{} import {}'\
            ...
            if tlobject.is_function:
                ...
                if tlobject.friendly:
                    ...
                    docs.write_text(
                        ...
                        'https://docs.nsplusthon.dev/en/stable/modules/client.html'
                        '#nsplusthon.client.{0}.{1}"><code>client.{1}()</code></a> '
                ...
                docs.write('''<pre>\
<strong>from</strong> nsplusthon.sync <strong>import</strong> SoroushClient
<strong>from</strong> nsplusthon <strong>import</strong> functions, types

<strong>with</strong> SoroushClient(name, api_id, api_hash) <strong>as</strong> client:
    result = client(''')
