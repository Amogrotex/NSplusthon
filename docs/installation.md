...
NSplusthon یک کتابخانه پایتون است، بنابراین ابتدا باید پایتون را از [python.org](https://www.python.org/downloads/) دانلود و نصب کنید (نسخه 3.7 یا بالاتر توصیه می‌شود).
