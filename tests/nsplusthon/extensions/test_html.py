"""
Tests for `nsplusthon.extensions.html`.
"""
from nsplusthon.extensions import html
from nsplusthon.tl.types import MessageEntityBold, MessageEntityItalic, MessageEntityTextUrl
...
def test_malformed_entities():
    ...
    result = html.unparse(text, entities)
    assert result == '🏆<a href="https://example.com">SoroushPlus Official Android Challenge is o</a>ver🏆.'
